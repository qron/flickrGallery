    ...
    func initFavoritesDirectories() {
        ...
        if let documentDirectoryUrl = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first {
            ...
            if FileManager.default.fileExists(atPath: favoritesThumbnailsDirectoryPath.path) == false {
                ...
                do {
                    try FileManager.default.createDirectory(atPath: favoritesThumbnailsDirectoryPath.path, withIntermediateDirectories: false, attributes: nil)
                } catch {
                    fatalError("Cannot create favorites thumbnails directory in file system")
                }
                
            }
            
            if FileManager.default.fileExists(atPath: favoritesDetailsDirectoryPath.path) {
                
                do {
                    try FileManager.default.createDirectory(atPath: favoritesDetailsDirectoryPath.path, withIntermediateDirectories: false, attributes: nil)
                } catch {
                    fatalError("Cannot create favorites details directory in file system")
                }
